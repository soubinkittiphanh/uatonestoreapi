...
const createChatType=async(req,res)=>{
    ...
    const sqlCom=`INSERT INTO chat_type( code, name, remark) VALUES ('${chat_type_id}','${chat_type_name}','${chat_type_remart}')`
...
const updateChatType=async(req,res)=>{
    ...
    const sqlCom=`UPDATE chat_type SET  name='${chat_type_name}', remark='${chat_type_remart}' WHERE code='${chat_type_id}'`
